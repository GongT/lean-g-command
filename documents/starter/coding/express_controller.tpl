...
<section id="step4">
	<h2>第三步：然后设置这个路由使用的http请求方法（这一步可以省略，默认是GET）</h2>
...
&lt;/div></code>
	...
	<a href="{$ABSURL}/reference/nsmarty_template.html">模板文档</a>
	<br/>
